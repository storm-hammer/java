...
public class LinkedListIndexedCollection<T> implements List<T> {
	 ...
	 * @author Mislav Prce
	 */
	private static class LinkedListIndexedCollectionGetter<T> implements ElementsGetter<T> {
		 ...
		 */
		public LinkedListIndexedCollectionGetter(LinkedListIndexedCollection<T> col) {
			super();
	...
	public void add(T value) {
		...
		ListNode<T> temp = new LinkedListIndexedCollection.ListNode<>(value);
	 ...
	 */
	public void connectOnly(ListNode<T> node) {
		first = node;
		last = node;
		size++;
		modificationCount++;
	 ...
	 * @param node the object to be added into the list
	 */
	public void connectLast(ListNode<T> node) {
		node.previous = last;
		last.next = node;
		last = node;
		size++;
	 ...
	 * @param node the object to be added into the list.
	 */
	public void connectFirst(ListNode<T> node) {
		node.next = first;
		first.previous = node;
		first = node;
		size++;
	 ...
	 */
	public void connectAtPosition(ListNode<T> node, int position) {
		...
		ListNode<T> newNext = nodeAtIndex(position);
		ListNode<T> newPrevious = newNext.previous;
	 ...
	 */
	public void disconnectNode(ListNode<T> node) {
	 ...
	 */
	public void disconnectFirst(ListNode<T> node) {
		modificationCount++;
		first = node.next;
		node.next = null;
	}
	 ...
	 * @param node the node to be disconnected from the list
	 */
	public void disconnectLast(ListNode<T> node) {
		modificationCount++;
		last = node.previous;
		node.previous = null;
	}
	 ...
	 * @param node the node to be disconnected from the list
	 */
	public void disconnectMiddle(ListNode<T> node) {
		modificationCount++;
	 ...
	 */
	public ListNode<T> nodeAtIndex(int index) {
	...
	public void insert(T value, int position) {
		...
		ListNode<T> newNode = new LinkedListIndexedCollection.ListNode<>(value);
