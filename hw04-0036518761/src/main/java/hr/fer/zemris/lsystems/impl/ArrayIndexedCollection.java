...
public class ArrayIndexedCollection<T> implements List<T> {
	...
	public ArrayIndexedCollection(Collection<? extends T> other, int initialCapacity) {
		...
		elements = (T[]) new Object[determinedCapacity];
		modificationCount = 0;
	 ...
	 * @author Mislav Prce
	 */
	private static class ArrayIndexedCollectionGetter<T> implements ElementsGetter<T> {
		 ...
		 */
		public ArrayIndexedCollectionGetter(ArrayIndexedCollection<T> col) {
			super();
